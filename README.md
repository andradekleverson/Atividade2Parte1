...
Surgindo originalmente a partir da sintaxe da linguagem JavaScript, o JSON passou a ser utilizado como meio de intercâmbio de dados padrão entre várias linguagens de programação. Isso se deve, em primeira instância, à sua estrutura simples, que pode ser lida e escrita por praticamente qualquer linguagem de programação, o que facilita demasiadamente a comunicação entre diferentes sistemas.
